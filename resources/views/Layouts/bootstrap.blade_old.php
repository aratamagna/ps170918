												...
												<form method="POST" action="{{ route('login') }}" autocomplete="off">
												            ...
												            <div class="form group has-feedback">
												                <label for="name">Usuario</label>
												                 <input class="form-control" name="name"  id="name" value="{{ old('name') }}" maxlength="12" onkeypress="return val(event)" onfocus="this.value=''" >
												            ...
												            <div class="form group has-feedback">
												              ...
												              <input class="form-control" type="password" name="password" onfocus="this.value=''">
...
if(1==1)
		...
		<script type="text/javascript" src="js/custom.js"></script>
                ...
                <script>
                function val(name) {
                    tecla = (document.all) ? name.keyCode : name.which;
