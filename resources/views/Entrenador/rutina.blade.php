                ...
                <?php $status=Session::get('status'); ?>
                                ...
                                @foreach($users as $user)
                                    <tr>
                                      ...
                                      <!-- <td></td>-->
                                        ...
                                        <td><button type="button" class="btn btn-link btn-sm" onClick="rutina_clienteesp('{{$user->id}}')"><i class="icon-search"> {{ $user->persona->per_rut }}</i></button></td>
                    ...
                    @endif
                        <div class="modal-dialog modal-lg">
                            <form action="registrar_cli_ruti" method="POST" id="form" name="form" >
                    ...
                    @endif
                        <div class="modal-dialog modal-lg">
                            <form action="editar_cli_eva" method="POST" id="formEdit" name="form" role="form" >
