    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <center><h2>Evaluaciones</h2></center>           
                <?php $status=Session::get('status'); ?>
                       ...
                       <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-condensed" id="example">
                            ...
                            <tbody>
                                ...
                                @foreach($users as $user)
                                    <tr>
                                       <!-- <td>      <a href="{{ URL::to('evaluaciones') }}" id="{{$user->id}}" class="btn btn-mini btn-primary">Edit Post</a>-->
                                      <!-- <td></td>-->
                                      
                                        <td><button type="button" class="btn btn-link btn-sm" onClick="evaluacion_clienteesp('{{$user->id}}')"><i class="icon-search"> {{ $user->persona->per_rut }}</i></button></td>

                                        
                                        <td><br>{{ $user->persona->per_nombre }}</td>
                                        <td><br>{{ $user->persona->per_apellidop }}</td>
                                        <td><br>{{ $user->persona->per_apellidom }}</td>
                                        <td><br>{{ $user->persona->per_nac }}</td>
                                        <td><br>{{ $user->persona->sexo->sex_nombre }}</td>                             
                                        <td><br>{{ $user->comuna->region->reg_nom }}</td>
                                        <td><br>{{ $user->comuna->com_nom }}</td>
                                        <td><br>{{ $user->persona->per_direccion }}</td>
                                        <td><br>{{ $user->persona->per_numdirec }}</td>
                                        <td><br>{{ $user->persona->per_numpiso }}</td>
                                        <td><br>{{ $user->persona->per_fono1 }}</td>
                                        <td><br>{{ $user->persona->per_fono2}}</td>
                                        <td><br>{{ $user->persona->per_correo }}</td>
                                        <td><br>{{ $user->email }}</td>
                                        <td>          
                                            @if(Session::has('errors') and $status=='error2' )
                                           <!-- <button type="button" name="#Edit2" id="{{$user->id}}"  class="edit2 btn btn-info btn-sm" data-toggle="modal" data-target=".bs-exampleeditabierto-modal-lg" ><i class="fa fa-pencil-square-o"> Editar</i></button>-->
                                            ...
                                            @else
                                           <!-- <button type="button" name="#Edit2" id="{{$user->id}}"  class="edit2 btn btn-info btn-sm" data-toggle="modal" data-target=".bs-exampleeditcerrado-modal-lg" ><i class="fa fa-pencil-square-o"> Editar</i></button>-->
                    ...
                    @endif
                        <div class="modal-dialog modal-lg">
                            <form action="registrar_cli_eva" autocomplete="off" method="POST" id="form" name="form">
                                <div class="modal-content">

                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title" id="myModalLabel">Registrar evaluación</h4>
                                    </div> 
                    ...
                    @endif
                        <div class="modal-dialog modal-lg">
                            <form action="editar_cli_eva" autocomplete="off" method="POST" id="formEdit" name="form" role="form">
