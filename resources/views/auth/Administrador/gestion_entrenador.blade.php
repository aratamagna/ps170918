    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <center><h2>Gestion Entrenador</h2></center>           
                <?php $status=Session::get('status'); ?>
                    @if($status=='ok_create')
                       <div class="alert alert-success fade in"><button class="close" data-dismiss="alert" type="button">×</button>
                        <center> El entrenador fue creado con éxito</center></div>
                    @endif
                    @if($status=='ok_delete')
                    <div class="alert alert-danger fade in"><button class="close" data-dismiss="alert" type="button">×</button>
                        <center> El entrenador fue eliminado con éxito</center></div>
                    @endif
                    @if($status=='ok_update')
                    <div class="alert alert-info fade in"><button class="close" data-dismiss="alert" type="button">×</button>
                        <center> El entrenador fue actualizado con éxito</center></div>
                    @endif
                
                    <!-- Button trigger modal -->
                    <!-- Large modal -->
                    @if(Session::has('errors') and $status=='error1' )
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target=".bs-exampleabierto-modal-lg"><i class="fa fa-plus-square"></i> Nuevo entrenador</button>
                    @else
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target=".bs-examplecerrado-modal-lg"><i class="fa fa-plus-square"></i> Nuevo entrenador</button>
                    @endif
                    ...
                    @endif
                        <div class="modal-dialog modal-lg">
                            <form action="registrar_ent" method="POST" id="form" name="form" autocomplete="off">
                                <div class="modal-content">

                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title" id="myModalLabel">Registrar entrenador</h4>
                                    </div> 
                        ...
                        <div class="modal-dialog modal-lg">
                            <form action="editar_ent" method="POST" id="formEdit" name="form" role="form" autocomplete="off">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title" id="myModalLabel">Editar entrenador</h4>
                                    </div> 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        {{Form::input("text", "usuario_edit",Input::old('usuario_edit'), array("class" => "form-control","id"=>"u","disabled"=>"disabled"))}}
			...
			$(document).ready( function() {
                ...
                // AJAX
                    $.get('ajax-subcat/' + cat_id, function(data){
                        $('#com').empty();
                            $.each(data, function(gestion_entrenador, subcatObj){
                ...
                <script language="javascript" type="text/javascript">
                    function eliminar(id_sup){
                        ...
                        if(confirm("\n\n¿ Está seguro de que desea eliminar entrenador?"))
                        {
                                window.location="eliminar-entrenador/"+id_sup;
