    ...
    <div class="container">
		...
		<div class="col-sm-12">
			...
			<div class="panel panel-success"> <!-- Permite crear paneles texto,formularios,videos-->
			  <div class="panel-heading"><center><h2>Cliente {{{$nom2}}} {{{$apell2}}} {{{$apell_2}}}</h2></center>   </div>
			       ...
			       @foreach($users as $user) 
                    ...
                    @endif
                        <div class="modal-dialog modal-lg">
                            <form action="editar_datos_cli" method="POST" id="formEdit" name="form" role="form" autocomplete="off">
